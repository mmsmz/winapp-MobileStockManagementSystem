...
{
    public partial class transfer_kandy : Form
    {
        SqlConnection conn;
        private int indexRow;

        public transfer_kandy()
        {
            try
            {
        ...
        private void transfer_kandy_Load(object sender, EventArgs e)
        {
            try
            {
                conn.Close();
        ...
        private void btnCOLOMBO_Click(object sender, EventArgs e)
        {
            if (!(txtitemno.Text.Equals("")))
            {
                try
                {
                    conn.Close();
                    conn.Open();
                    string search = "SELECT * FROM Kandy_branch WHERE Item_No = '" + txtitemno.Text + "'";
                    ...
                    if (!(txtitemno.Text.Equals("")))
                    {
                        ...
                        conn.Open();
                        SqlCommand deleteCommand = new SqlCommand("delete from Kandy_branch where Item_No=@Item_No", conn);
